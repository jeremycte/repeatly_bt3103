		...
		<div class="student-dashboard-homepage screen">
			...
			<div class="create-deck-overlap-group">
				<div class="overlap-group-createdeck">
					<img
						class="illustration"
						src="../../img/Dashboard/history-illustrations.png"
					/>
					<div
						class="overlap-group-nameUrDeck border-1px-quick-silver"
					>
						<input
					...
					<div
						class="overlap-group-createdeckTag border-1px-quick-silver"
					>
						<input
							class="createDeck inter-normal-silver-chalice-30px"
							id="deckTag"
					...
					<div
						class="overlap-group-txtareaCreateDeck border-1px-quick-silver"
					>
						<textarea
