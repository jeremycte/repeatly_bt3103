		...
		<div class="student-edit-card-deck-edit-existing-question screen">
			...
			<div class="overlap-group5">
				<div class="left-container-editquestion">
					<div class="card-title">Create/edit Question</div>
					<div class="title">
						\
						<div class="title-1 inter-semi-bold-black-18px">
							Title:
						</div>
						<div class="title-2">
					...
					<div class="question">
						<div class="question-1 inter-semi-bold-black-18px">
							Question:
						</div>
					...
					<div class="answer">
						<div class="answer-1 inter-semi-bold-black-18px">
							Answer:
						</div>
						<div class="answer-2">
				...
				<div class="overlap-group-container">
					<button class="overlap-group-2" v-on:click="save()">
						<div
							class="save valign-text-middle inter-semi-bold-white-20px"
						>
							SAVE
						</div>
					</button>
					<button class="overlap-group1-2" v-on:click="cancel()">
						<div
							class="cancel valign-text-middle inter-semi-bold-white-20px"
						>
							CANCEL
						</div>
					</button>
			...
			<div class="confirmed-questions">
				<div
					class="questions-classification"
				...
				>
					<div class="flex-row-2" v-if="index === this.selectedIndex">
						<div class="flex-col">
							...
							<div
								class="how-is-headers-created-in-html-1 valign-text-middle inter-semi-bold-black-28px"
							>
								{{ item["question"] }}
							</div>
							<div
								class="answer-using-header-1 inter-normal-black-20px-2"
							>
								Answer: {{ item["answer"] }}
							</div>
						</div>
						<div class="overlap-group-container">
							<button
								class="editdeck-delete-button"
								v-on:click="deleteCard(index)"
							>
								<div
									class="delete valign-text-middle inter-semi-bold-white-20px"
								>
									DELETE
								</div>
							</button>
				...
				try {
					...
					if (
						...
						if (this.selectedIndex === null) {
							...
							this.documents[this.selectedIndex]["question"] =
								questionInput;
							this.documents[this.selectedIndex]["answer"] =
								answerInput;
							this.documents[this.selectedIndex]["title"] =
								titleInput;
							const updateRef = doc(
								db,
								"groups",
